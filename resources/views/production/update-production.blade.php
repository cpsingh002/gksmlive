    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Edit Production Details</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('production_name') is-invalid @enderror" id="productionName" name="production_name" placeholder="Enter Production Name" value="{{$production->production_name}}" required>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <textarea name="production_description" id="editor1" class="form-control @error('production_description') is-invalid @enderror">{{$production->production_description}}</textarea>
