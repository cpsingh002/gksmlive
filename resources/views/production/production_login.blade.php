                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" method="post" action="{{ route('login.production') }}">
                                        @csrf
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="text" class="form-control @error('production_user_name') is-invalid @enderror" id="username" name="production_user_name" value="" placeholder="Enter Production User Name">
                                            @error('production_user_name')
