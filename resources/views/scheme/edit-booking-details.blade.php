                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="associate_name" value="{{$propty_detail->associate_name}}"  class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="associate_number" value="{{$propty_detail->associate_number}}"  class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="associate_rera_number" value="{{$propty_detail->associate_rera_number}}"  class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
