                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="adhar_card_number" class="form-control" id="schemeImg" min="12" max="12" required>
