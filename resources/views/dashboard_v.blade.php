...
<div class="container-fluid">
    ...
    <!--                <div class="col-12">-->
    <!--                    <div class="text-center">-->
    <!--                        <h4 class="mb-0">Production House  Data</h4>-->
    <!--                    </div>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--            <div class="card-body">-->
    ...
    <!--                <div class="col-12">-->
    <!--                    <div class="text-center">-->
    <!--                        <h4 class="mb-0">Opertors Data</h4>-->
    <!--                    </div>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--            <div class="card-body">-->
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header py-2 bg-lightgray ">
                    <div class="col-12">
                        <div class="text-center">
                            <h5 class="mb-0">Completed Plots</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                       ...
                       <table class="example1 table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr ed="{{$data->payment_id}}">
                                ...
                                <td>
                                    <a href="{{ route('property.dbook-hold-proof-details', ['property_id' => $data->payment_id]) }}"  class=" savepayment mt-1"  data-toggle="tooltip" data-placement="top" title="view"><button class="btn btn-sm btn-success">View</button></a>  
                                </td>
                            </tr>
                            @php($count++)
                            @endforeach
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header py-2  bg-primary">
                    <div class="col-12">
                        <div class="text-center">
                            <h4 class="mb-0 text-white">Waiting Lists at Units</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
