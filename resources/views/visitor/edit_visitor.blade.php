        ...
        <div class="offset-xl-2 col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="needs-validation" method="post" action="{{ route('visitor.update') }}" novalidate>
                        @csrf
                        <div class="row">
                            <!-- <input type="hidden" name="parent_id" value="{{Auth::user()->id}}"> -->
                            <input type="hidden" name="parent_user_type" value="{{Auth::user()->user_type}}">
                            <input type="hidden"   name="user_id" value="{{$visitor->public_id}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="servicearea" class="form-control @error('parent_id') is-invalid @enderror" name="parent_id" required="required">
                                        ...
                                        @foreach($products as $list)  
                                            @if($visitor->parent_id==$list->production_id)
                                                <option selected value="{{$list->production_id}}">
                                            @else
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('user_name') is-invalid @enderror" id="productionName" name="user_name" placeholder="Enter User Name" value="{{$visitor->name}}" required>
                                    @error('user_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{$visitor->email}}" id="productionImg">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" id="productionImg" min="0" max="12" value="{{$visitor->mobile_number}}">
                                    @error('mobile_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
