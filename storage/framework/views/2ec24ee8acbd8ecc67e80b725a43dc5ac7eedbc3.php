                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="team"  class="form-control">
                                                    ...
                                                    <?php if($scheme_detail[0]->team==$list->public_id): ?>
                                                    <option selected value="<?php echo e($list->public_id); ?>">
                                                    <?php else: ?>
                                                    <option value="<?php echo e($list->public_id); ?>">
                                                    <?php endif; ?>
                                                     <?php echo e($list->team_name); ?></option>
                                                    <!--<option value=<?php echo e($scheme_detail[0]->team == $list->public_id ? 'selected' : ''); ?> value="<?php echo e($list->public_id); ?>"><?php echo e($list->team_name); ?></option>     -->
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select> 
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bookingg/public_html/resources/views/scheme/edit-scheme.blade.php ENDPATH**/ ?>