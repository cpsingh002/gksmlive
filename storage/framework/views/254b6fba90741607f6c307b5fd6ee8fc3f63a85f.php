        ...
        <div class="offset-xl-2 col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form class="needs-validation" method="post" action="<?php echo e(route('property.hold_property')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\associate\resources\views/scheme/hold-property.blade.php ENDPATH**/ ?>