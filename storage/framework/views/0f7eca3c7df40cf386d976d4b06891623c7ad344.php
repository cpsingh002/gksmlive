...
unset($__errorArgs, $__bag); ?>" id="username" name="associate_name" value="" placeholder="Enter Associate Name">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['associate_rera_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Applier Name</label>
...
unset($__errorArgs, $__bag); ?>" id="username" name="applier_name" value="" placeholder="Enter Applier Name">
...
</html><?php /**PATH F:\xampp\htdocs\associate\resources\views/register.blade.php ENDPATH**/ ?>