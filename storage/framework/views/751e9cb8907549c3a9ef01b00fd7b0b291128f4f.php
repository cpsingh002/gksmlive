                ...
                <div class="card-header">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <a href="<?php echo e(URL::to('/add-user')); ?>" type="button" class="btn btn-success waves-effect waves-light">Add Associate</a>
                            </div>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\associate\resources\views/users/users.blade.php ENDPATH**/ ?>