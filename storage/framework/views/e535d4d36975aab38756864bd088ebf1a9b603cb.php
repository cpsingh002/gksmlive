                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <?php if(Auth::user()->user_type == 1): ?> 
                                ...
                                <a href="<?php echo e(URL::to('admin/add-scheme')); ?>" type="button" class="btn btn-success waves-effect waves-light">Add Scheme</a>
                            <?php elseif(Auth::user()->user_type == 2): ?> 
                                
                                <a href="<?php echo e(URL::to('production/add-scheme')); ?>" type="button" class="btn btn-success waves-effect waves-light">Add Scheme</a>
                            <?php elseif(Auth::user()->user_type == 3): ?> 
                                
                                <a href="<?php echo e(URL::to('opertor/add-scheme')); ?>" type="button" class="btn btn-success waves-effect waves-light">Add Scheme</a>
                            <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <?php if((Auth::user()->user_type == 4) && (Auth::user()->all_seen == 0)&&(!in_array(Auth::user()->team, $teams))): ?>
                                <?php ($count=1); ?>
                                <?php $__currentLoopData = $schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($scheme->scheme_team == Auth::user()->team): ?>
                                        <tr>
                                            <td> <?php echo e($count); ?> </td>
                                            <td><?php echo e($scheme->production_name); ?></td>
                                            <td><?php echo e($scheme->scheme_name); ?></td>
                                            <td><?php echo e($a_slot[$scheme->scheme_id]); ?></td>
                            ...
                            <?php elseif((Auth::user()->user_type == 3) || (Auth::user()->user_type == 2) ): ?>
                             
                                <?php ($count=1); ?>
                                <?php $__currentLoopData = $schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($scheme->upublic_id == Auth::user()->parent_id): ?>
                                    <tr>
                                        <td> <?php echo e($count); ?> </td>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gksm\resources\views/scheme/schemes.blade.php ENDPATH**/ ?>