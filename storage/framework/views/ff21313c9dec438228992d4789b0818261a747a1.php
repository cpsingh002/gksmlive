                                         ...
                                         <!--<div class="card <?php if($property->status == 2): ?> border-success <?php elseif($property->status == 3): ?> border-danger <?php endif; ?>" style="width: 18rem;">-->
                                            ...
                                            <div class="card-body">
                                                <?php if(Auth::user()->user_type != 4): ?>
                                                    <a href="<?php echo e(route('view.property', ['id' => $property->property_public_id])); ?>">
                                                        <!-- <h5 class="card-title">S. No <?php echo e($property->plot_no); ?></h5> -->
                                                        <h5 class="card-title">S. No <?php echo e($i); ?></h5>
                                                    </a>
                                                <?php else: ?>
                                                     <h5 class="card-title">S.No<?php echo e($i); ?></h5> 
                                                <?php endif; ?>

                                                <?php if($property->plot_type == 'P'): ?>
                                            ...
                                            <?php if($property->management_hold > 0): ?>
                                                ...
                                                <ul class="list-group-flush" style="list-style:none;">
                                                    ...
                                                    <?php if(Auth::user()->user_type != 4): ?>
                                                    <li>
                                                        <a href="<?php echo e(route('cancel.property-cancel',['id' => $property->property_public_id])); ?>" class="card-link text-danger">Cancle</a>
                                            ...
                                            <ul class="list-group-flush" style="list-style:none;">
                                                ...
                                                <?php endif; ?>
                                                <?php if(Auth::user()->user_type != 4 && ($property->status == 2 || $property->status == 3)): ?>
                                                <li>
                                                    <a href="<?php echo e(route('property.edit_customer', ['scheme_id' => $property->scheme_id, 'property_id' => $property->property_public_id])); ?>" class="card-link">Edit customer</a>
                                                </li>
                                                <?php endif; ?>
                                            ...
                                            <ul class="list-group-flush" style="list-style:none;">
                                                ...
                                                <li>
                                                     <!-- <a href="<?php echo e(route('cancel.property-cancel',['id' => $property->property_public_id])); ?>" class="card-link text-danger">Cancle</a> -->
                                                     <a onclick="return confirm('Are you sure you want to cancel this booking ?')" href="<?php echo e(route('complete.property-cancel',['id' => $property->property_public_id])); ?>" class="card-link text-danger">Cancle</a>
                                                </li>
                                                <?php endif; ?>
                                            ...
                                            <ul class="list-group-flush" style="list-style:none;">
                                                ...
                                                <li>
                                                    <a href="<?php echo e(route('for-managment.property-delete',['id' => $property->property_public_id])); ?>" class="card-link text-danger">Delete</a>
                                                    <!-- <a onclick="return confirm('Are you sure you want to delete this plot ?')" href="<?php echo e(route('for-managment.property-delete',['id' => $property->property_public_id])); ?>" class="card-link text-danger">Delete</a> -->
                                                </li>
                                                <?php endif; ?>
                                            </ul>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gksm\resources\views/scheme/properties.blade.php ENDPATH**/ ?>