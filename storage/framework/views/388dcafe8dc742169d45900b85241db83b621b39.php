    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(URL::to('/schemes')); ?>">
                        <i data-feather="grid"></i>
                ...
                <li>
                    <a href="<?php echo e(URL::to('/import-csv')); ?>">
                        <i data-feather="grid"></i>
...
</div><?php /**PATH C:\xampp\htdocs\realstate_dashboard\resources\views/dashboard/left_bar.blade.php ENDPATH**/ ?>