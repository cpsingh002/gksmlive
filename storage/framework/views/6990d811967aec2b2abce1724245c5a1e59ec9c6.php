                        ...
                        <?php ($count=1); ?>
                            ...
                            <tr>
                                ...
                                <?php if($attribute->status==1): ?>
                                    <a href="<?php echo e(route('attribute.status',['id'=>$attribute->public_id,'status'=>0])); ?>" data-toggle="tooltip" data-placement="top" title="Change Status" class="text-success">Active</a>
                                 <?php elseif($attribute->status==0): ?>
                                    <a href="<?php echo e(route('attribute.status',['id'=>$attribute->public_id,'status'=>1])); ?>" data-toggle="tooltip" data-placement="top" title="Change Status" class="text-warning">Deactive</a>
                                <?php endif; ?>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dmlux/public_html/project/resources/views/attribute/attributes.blade.php ENDPATH**/ ?>