                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            ...
                            <h4 class="mb-3">
                                <span class="counter-value" data-target="37">0</span>
                            </h4>
                        </div>
                        <!-- <div class="col-6">
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\realestate\resources\views/dashboard.blade.php ENDPATH**/ ?>