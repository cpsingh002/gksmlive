                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class=""><a href="<?php echo e(route('show.report-detail', ['id' => $book_property->property_public_id])); ?>" ata-toggle="tooltip" data-placement="top" title="view Detail"><i class="fas fa-info-circle text-info"></i></a></td>
                                <?php else: ?>
                                <td class="text-primary fw-bold">Management Hold</td>
                                <td class=""><a href="<?php echo e(route('show.report-detail', ['id' => $book_property->property_public_id])); ?>" ata-toggle="tooltip" data-placement="top" title="view Detail"><i class="fas fa-info-circle text-info"></i></a></td>
                                <?php endif; ?>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dmlux/public_html/project/resources/views/scheme/reports.blade.php ENDPATH**/ ?>