                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="scheme_name" class="form-control" id="schemeName">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="plot_count" class="form-control" id="schemeImg">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="scheme_img" class="form-control" id="schemeImg">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="brochure" class="form-control" id="schemeImg">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="location" class="form-control" id="schemeImg">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\realestate\resources\views/scheme/add-scheme.blade.php ENDPATH**/ ?>