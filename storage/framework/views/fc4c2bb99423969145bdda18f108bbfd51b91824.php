    ...
    <div class="row">
        <div class="offset-xl-2 col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" method="post" action="<?php echo e(route('cancel.property')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bookingg/public_html/resources/views/property/property-cancel-reson.blade.php ENDPATH**/ ?>