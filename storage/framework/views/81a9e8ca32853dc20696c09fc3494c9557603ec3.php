                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="<?php echo e(URL::to('/login')); ?>" class="d-block auth-logo">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <?php endif; ?>
                                    <form class="mt-4 pt-2" method="post" action="<?php echo e(route('forgot-password.check-email')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="">
                                            <a href="<?php echo e(URL::to('/login')); ?>" class="btn btn-primary w-100">Login ?</a>
                                        </div>
                                    </div>
...
</html><?php /**PATH /home/dmlux/public_html/project/resources/views/forgot_password.blade.php ENDPATH**/ ?>