                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <i class="fas fa-pencil-alt text-primary" data-toggle="tooltip" data-placement="top" title="Edit">
                                    </i>
                                    <a href="<?php echo e(route('scheme.destroy', ['id' => $scheme->scheme_public_id])); ?>" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fas fa-recycle text-danger"></i></a>
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\associate\resources\views/scheme/schemes.blade.php ENDPATH**/ ?>