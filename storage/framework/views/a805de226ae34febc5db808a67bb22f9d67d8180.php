...
<div class="container-fluid">
    ...
    <div class="row">
        <?php if(Auth::user()->user_type == 1): ?> 
            <form class="needs-validation" method="post" action="<?php echo e(URL::to('admin/add-scheme')); ?>" enctype="multipart/form-data">                   
           
        <?php elseif(Auth::user()->user_type == 2): ?> 
            <form class="needs-validation" method="post" action="<?php echo e(URL::to('production/add-scheme')); ?>" enctype="multipart/form-data">
            
        <?php elseif(Auth::user()->user_type == 3): ?> 
            <form class="needs-validation" method="post" action="<?php echo e(URL::to('opertor/add-scheme')); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="1" name="plot_count" class="form-control <?php $__errorArgs = ['plot_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="editor1" name="description"></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="1" name="account_number" class="form-control <?php $__errorArgs = ['account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make("dashboard.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gksm\resources\views/scheme/add-scheme.blade.php ENDPATH**/ ?>